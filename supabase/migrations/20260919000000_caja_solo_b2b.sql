-- ============================================================================
--  El precio de caja solo para tienda y mayorista (13 sep 2026, noche).
--
--  Abraham preguntó si «el precio lo cobra el servidor» reabría el riesgo del
--  6 sep (el navegador decidía el precio). No lo reabre: el servidor sigue
--  ignorando el precio que manda el navegador y cotiza contra productos. Pero
--  crear_pedido aplicaba el precio de caja a CUALQUIER nivel que mandara
--  `caja`: la app no ofrece cajas al consumidor, y aun así una llamada a mano
--  al RPC con `caja: 12` pagaba $300 (precio de caja de tienda) en vez de
--  12 × $35. Comprobado en staging: PED-00033.
--
--  Esta migración es la 20260918000000 con una guarda: el precio de caja (y
--  `piezas_por_caja`) solo cuando v_nivel es tienda o mayorista. Consumidor,
--  restaurante y mostrador pagan siempre piezas × su precio.
--
--  Staging primero; verificar con un pedido de consumidor que declare el
--  precio de caja: debe volver `precio_cambiado` con totalCorrecto = 12 × precio.
-- ============================================================================
